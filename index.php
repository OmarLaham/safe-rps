                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="index.php">
                                <img style="margin-top: 8px;" src="assets/images/logo.png" alt="Logo">
                            </a>
                        ...
                        <div class="blog-content">
                            <div class="blog-author d-flex align-items-center">
                                ...
                                <div class="author-content media-body">
                                    ...
                                    <h4 class="sub-title text-danger">Frankfurt Institute for Advanced Studies<br/>Holder of the Johanna Quandt Chair for Theoretical Life Sciences</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-contact-info contact-color-2 mt-30 d-flex  wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.6s">
                            ...
                            <div class="contact-info-content media-body">
                                <p class="text"><a href="mailto:hello@clinicloud-io.com">hello@clinicloud-io.com</a></p>
                            </div>
                        </div> <!-- single contact info -->
                    </div>
                    <div class="col-lg-4 col-md-6">
